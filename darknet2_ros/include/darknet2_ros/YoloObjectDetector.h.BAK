...
// darknet2_ros_msgs
#include <darknet2_ros_msgs/BoundingBoxes.h>
#include <darknet2_ros_msgs/BoundingBox.h>
#include <darknet2_ros_msgs/CheckForObjectsAction.h>

// Jackrabbot darknet2_msgs
//#include <darknet_msgs/bbox_array.h>
//#include <darknet_msgs/bbox_array_stamped.h>
//#include <darknet_msgs/bbox.h>

namespace darknet2_ros {
...
//! Class labels.
const std::string voc_classLabels_[] = { "aeroplane", "bicycle", "bird", "boat", "bottle", "bus", "car", "cat",
    "chair", "cow", "dining table", "dog", "horse", "motorbike", "person",
    "potted plant", "sheep", "sofa", "train", "tv monitor" };

const std::string classLabels_[] = { "person","bicycle","car","motorcycle","airplane","bus","train","truck",
		...
		"baseball glove","skateboard","surfboard","tennis racket","bottle","wine glass","cup","fork","knife","spoon","bowl","banana","apple","sandwich",
...
class YoloObjectDetector
{
 ...
 private:
  ...
  //! Typedefs.
  typedef actionlib::SimpleActionServer<darknet2_ros_msgs::CheckForObjectsAction> CheckForObjectsActionServer;
  ...
  darknet2_ros_msgs::BoundingBoxes boundingBoxesResults_;
  RosBox_* boxes_;
