...
typedef actionlib::SimpleActionClient<darknet2_ros_msgs::CheckForObjectsAction> CheckForObjectsActionClient;
...
void checkForObjectsResultCB(
    ...
    const darknet2_ros_msgs::CheckForObjectsResultConstPtr& result)
{
...
bool sendImageToYolo(ros::NodeHandle nh, std::string imageName)
{
  ...
  nh.param("/darknet2_ros/camera_action", checkForObjectsActionName, std::string("/darknet/check_for_objects"));
  ...
  // Generate goal.
  darknet2_ros_msgs::CheckForObjectsGoal goal;
  goal.image = *image;
