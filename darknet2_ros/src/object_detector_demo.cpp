...
#include "parser.h"
#include "box.h"
#include "darknet2_ros/image_interface.h"
#include <sys/time.h>
}
...
static darknet2_ros::RosBox_ *ROI_boxes;
                       ...
                       int w, int h, int frames, int fullscreen)
{
	...
	ROI_boxes = (darknet2_ros::RosBox_ *)calloc(l.side*l.side*l.n, sizeof(darknet2_ros::RosBox_));
...
extern "C" darknet2_ros::RosBox_ *demo_yolo()
{
  if (count == 0) {
    ++count;
    fetch_in_thread(0);
