...
{
  darknet2_ros_msgs::BoundingBox boundingBox;
...
void YoloObjectDetector::runYolo(cv::Mat &fullFrame, int id)
{
  ...
  if (isCheckingForObjects())
  {
    ...
    darknet2_ros_msgs::CheckForObjectsResult objectsActionResult;
...
void YoloObjectDetector::checkForObjectsActionGoalCB()
{
  ...
  boost::shared_ptr<const darknet2_ros_msgs::CheckForObjectsGoal> imageActionPtr = checkForObjectsActionServer_->acceptNewGoal();
